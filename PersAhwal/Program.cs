...
namespace PersAhwal
{
    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            //Application.Run(new MainForm("موظف ارشفة", 3, "57", "لبيب محمد أحمد", "نائب قنصل", dataSource100S, dataSource100A, @"D:\PrimariFiles\ModelFiles\", archFile, @"D:\PrimariFiles\FormData\", FormDataFile + @"\", true, "05-18-2023", "10-27-1444", Modelfilespath, FormDataFile, false));
