...
namespace PersAhwal
{
    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            //Application.Run(new MainForm("موظف ارشفة", 3, "57", "لبيب محمد أحمد", "نائب قنصل", dataSource100S, dataSource100A, @"D:\PrimariFiles\ModelFiles\", archFile, @"D:\PrimariFiles\FormData\", FormDataFile + @"\", true, "05-04-2023", "09-14-1444", Modelfilespath, FormDataFile, false));            
