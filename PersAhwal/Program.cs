...
namespace PersAhwal
{
    ...
    static class Program
    {
        ...
        static void Main()
        {
            ...
            //Application.Run(new MainForm("موظف ارشفة", 3, "57", "لبيب محمد أحمد", "نائب قنصل", dataSource100S, dataSource100A, @"D:\PrimariFiles\ModelFiles\", archFile, @"D:\PrimariFiles\FormData\", FormDataFile + @"\", true, "06-01-2023", "11-12-1444", Modelfilespath, FormDataFile, false));
