...
namespace PersAhwal
{
    public partial class FormAuth : Form
    {
        ...
        public void boxesPreparations(bool lawFullStet)
        {
            ...
            string residState = "، المقيم" + preffix[صفة_مقدم_الطلب_off.SelectedIndex, 5] + " بالمملكة العربية السعودية حامل";
                ...
                if (foundList[i] == "تعليق")
                {
                    ...
                    foreach (Control control in panel.Controls)
                    {
                        ...
                        if (name == foundList[i])
                        {
                           ...
                           // MessageBox.Show(foundList[i] + " - " + control.Text);
        ...
        public void addAuthenticPerson(string name, string sex, string nationality, string docNo, string docType)
        {
            // 
            // label42
            // 
            ...
            nantionality.Size = new System.Drawing.Size(244, 35);
            ...
            labeldocType.Name = "label4_" + addAuthticIndex + ".";
            ...
            DocType.Name = "نوع_هوية_" + addAuthticIndex + ".";
            ...
            DocType.TextChanged += new System.EventHandler(this.DocTypeAuth_TextChanged);
            ...
            authIDNo.Size = new System.Drawing.Size(300, 35);
            ...
            addAuthPic.Size = new System.Drawing.Size(35, 35);
            ...
            removeAuthPic.Size = new System.Drawing.Size(35, 35);
            ...
            autoCompleteBulk(DocType, DataSource, "نوع_هوية", "TableAuth");
            autoCompleteBulk(DocType, DataSource, "جنسية_الموكل", "TableAuth");
            ...
            PanelAuthPers.Controls.Add(labeldocType);
            PanelAuthPers.Controls.Add(DocType);
        ...
        private void addAuthPic_Click(object sender, EventArgs e)
        {
            ...
            addAuthenticPerson("", "ذكر", "سوداني الجنسية", "P0", "جواز سفر");
            btnPanelAuthPers.Height = PanelAuthPers.Height = 90 * addAuthticIndex;
            checkChanged(جنس_الموكَّل, PanelAuthPers);
            checkChanged(جنسية_الموكل, PanelAuthPers);
            checkChanged(الموكَّل, PanelAuthPers);
            checkChanged(هوية_الموكل, PanelAuthPers);
            checkChanged(نوع_هوية, PanelAuthPers);
        }
        ...
        public void addNames(string name, string sex, string docType, string docNo, string docIssue, string language, string job, string age, string resdiencey, string exp)
        {
            ...
            // checkSexType1
            // 
            CheckBox checkResidType = new CheckBox();
            checkResidType.AutoSize = true;
            checkResidType.Font = new System.Drawing.Font("Arabic Typesetting", 18F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            checkResidType.Location = new System.Drawing.Point(280, 3);
            checkResidType.Name = "وضع_الإقامة_" + addNameIndex + ".";
            checkResidType.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
            checkResidType.Size = new System.Drawing.Size(49, 31);
            checkResidType.TabIndex = 177;
            if (resdiencey == "")
                resdiencey = "مقيم";
            checkResidType.Text = resdiencey;
            if (checkResidType.Text == "مقيم")
                checkResidType.Checked = true;
            else checkResidType.Checked = false;
            checkResidType.UseVisualStyleBackColor = true;
            checkResidType.CheckedChanged += new System.EventHandler(this.resCheckedChanged);
            ...
            DocType.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
            DocType.Size = new System.Drawing.Size(120, 35);
            DocType.TabIndex = 122;
            DocType.Text = docType;
            ...
            DocIssue.Size = new System.Drawing.Size(215, 35);
            ...
            addName.Size = new System.Drawing.Size(35, 35);
            ...
            removeName.Size = new System.Drawing.Size(35, 35);
            ...
            textJob.Size = new System.Drawing.Size(423, 35);
            ...
            // label37
            // 
            Label expirLab = new Label();
            expirLab.AutoSize = true;
            expirLab.Font = new System.Drawing.Font("Arabic Typesetting", 18F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            expirLab.Location = new System.Drawing.Point(724, 555);
            expirLab.Name = "label38_" + addNameIndex + ".";
            expirLab.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
            expirLab.Size = new System.Drawing.Size(75, 27);
            expirLab.TabIndex = 606;
            expirLab.Text = "انتهاء الصلاحية:";
            // 
            // تاريخ_الميلاد
            //
            TextBox textExp = new TextBox();
            textExp.Font = new System.Drawing.Font("Arabic Typesetting", 18F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            textExp.Location = new System.Drawing.Point(522, 552);
            textExp.Name = "انتهاء_الصلاحية_" + addNameIndex + ".";
            textExp.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
            textExp.Size = new System.Drawing.Size(90, 35);
            textExp.TabIndex = 844;
            textExp.Text = exp;
            textExp.TextChanged += new System.EventHandler(this.textExp_TextChanged);
            // 
            // label37
            // 
            Label Age = new Label();
            ...
            textAge.Size = new System.Drawing.Size(120, 35);
            ...
            Panelapp.Controls.Add(checkResidType);
            ...
            Panelapp.Controls.Add(expirLab);
            Panelapp.Controls.Add(textExp);
        ...
        private bool checkDate()
        {
            foreach (Control control in Panelapp.Controls)
            {
                ...
                if (control is TextBox || control is ComboBox)
                {
                    if ((control.Name.Contains("انتهاء_الصلاحية") && control.Name != "انتهاء_الصلاحية") || (control.Name.Contains("تاريخ_الميلاد") && control.Name != "تاريخ_الميلاد"))
                    {
        ...
        private void textExp_TextChanged(object sender, EventArgs e)
        {
            ...
            if (textBox.Text.Length == 11)
            {
                textBox.Text = lastInp; return;
            }
            if (textBox.Text.Length == 10) return;
            if (textBox.Text.Length == 4) textBox.Text = "-" + textBox.Text;
            else if (textBox.Text.Length == 7) textBox.Text = "-" + textBox.Text;
            lastInp = textBox.Text;
        ...
        public string[] getID(TextBox text, int textID)
        {
            ...
            try
            {
                ...
                returnedText[6] = appExp.Split('_')[textID];
        ...
        private void DocTypeAuth_TextChanged(object sender, EventArgs e)
        {
            checkChanged(نوع_هوية, PanelAuthPers);
        }
        ...
        private void resCheckedChanged(object sender, EventArgs e)
        {
            CheckBox checkBox = (CheckBox)sender;
            if (checkBox.CheckState == CheckState.Unchecked) 
                checkBox.Text = "زائر";
            else checkBox.Text = "مقيم";
            checkChanged(وضع_الإقامة, Panelapp);
        }
        ...
        private void addName_Click(object sender, EventArgs e)
        {
            ...
            addNames("", "ذكر", "جواز سفر", "P0", "", "العربية", "", "", "مقيم","");
            btnPanelapp.Height = btnSaveApp.Height = Panelapp.Height = 130 * addNameIndex;
            checkChanged(مقدم_الطلب, Panelapp);
            checkChanged(النوع, Panelapp);
            checkChanged(نوع_الهوية, Panelapp);
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dataGridView1.CurrentRow.Index != -1)
            {
                ...
                {
                    string appJob, appBirth, iqamaStatus, expDate;
                    try
                    {
                        appJob = المهنة.Text.Split('_')[app];
                        appBirth = تاريخ_الميلاد.Text.Split('_')[app];
                        iqamaStatus = وضع_الإقامة.Text.Split('_')[app];
                        expDate = انتهاء_الصلاحية.Text.Split('_')[app];
                    }
                    catch (Exception ex)
                    {
                        appBirth = appJob = iqamaStatus = expDate = "";
                    }

                    if (مقدم_الطلب.Text.Split('_')[app] != "")
                    {
                        addNames(مقدم_الطلب.Text.Split('_')[app], النوع.Text.Split('_')[app], نوع_الهوية.Text.Split('_')[app], رقم_الهوية.Text.Split('_')[app], مكان_الإصدار.Text.Split('_')[app], "العربية", appJob, appBirth, iqamaStatus, expDate);
                        archState = "old";
                    }
                    else
                    {
                        addNames("", "ذكر", "جواز سفر", "P0", "", "العربية", "", appBirth, "مقيم", "");
                        archState = "new";

                    }
                }
                Console.WriteLine(FilespathOut + "autoDocs.txt");
                ...
                for (int app = 0; app < الموكَّل.Text.Split('_').Length; app++)
                {
                    ...
                    try
                    {
                        str = الموكَّل.Text.Split('_')[app];
                        appDocType = نوع_هوية.Text.Split('_')[app];
                    }
                    catch (Exception ex) {
                        appDocType = "";
                    }
                    ...
                    if (str != "")
                        addAuthenticPerson(الموكَّل.Text.Split('_')[app], جنس_الموكَّل.Text.Split('_')[app], جنسية_الموكل.Text.Split('_')[app], هوية_الموكل.Text.Split('_')[app], appDocType);
        ...
        public void PopulateCheckBoxes(string col, string table, string dataSource, int caseIndex, bool changeText)
        {            
            if (col == "الحقوق" || col == "Col" || col == "" || table == "" || dataSource == "") return;
            string query = "SELECT ID," + col.Replace("-", "_") + " FROM " + table +" where ID = 40";
            string textRights = "";
            using (SqlConnection con = new SqlConnection(dataSource))
            {
                using (SqlDataAdapter sda = new SqlDataAdapter(query, con))
                {
                    ...
                    {
                        textRights = getRights("الصيغة_العامة", "TableAuthRights", DataSource);
                        col = "الصيغة_العامة";
                        //MessageBox.Show("textRights " + textRights);
                    }

                    foreach (DataRow row in checkboxdt.Rows)
                    {
                        textRights = row[col.Replace("-", "_")].ToString();
                        Console.WriteLine(textRights);
                        textRights = SuffReplacements(textRights, caseIndex, صفة_الموكل_off.SelectedIndex);
                        foreach (string texts in textRights.Split('،'))
                        {
                            if (texts.Contains("الحق في توكيل الغير"))
                                authother = texts;
                            if (texts.Contains("ويعتبر التوكيل الصادر"))
                                removeAuthother = texts;
                            if (texts.Contains("لمن يشهد والله"))
                                lastSentence = texts;
                        }

                        
                        //if (checkboxdt.Rows[Nobox][col.Replace("-", "_")].ToString() == "" || checkboxdt.Rows[Nobox][col.Replace("-", "_")].ToString() == "null")
                        //    return;
        ...
        public string getRights(string col, string table, string dataSource)
        {            
            string query = "SELECT " + col.Replace("-", "_") + " FROM " + table + " where ID = 40";
            //MessageBox.Show(col);
            string colText = "";
            using (SqlConnection con = new SqlConnection(dataSource))
            {
                ...
                using (SqlDataAdapter sda = new SqlDataAdapter(query, con))
                {
                    ...
                    {                        
                        try
                        {
                            colText = row[col.Replace("-", "_")].ToString();
                        }
                        catch (Exception ex) { colText = ""; }

                        if (colText == "")
                            return "";
                        //colText = SuffReplacements(colText, صفة_مقدم_الطلب_off.SelectedIndex, صفة_الموكل_off.SelectedIndex);
                        //MessageBox.Show(colText);
                        foreach (string text in colText.Split('،'))
                        {
                        ...
                        try
                        {
                            if (!توكيل_الغير.Checked && authother != "")
                            {
                                colText = colText.Replace(authother, "") + " ";
                            }
                            if (!إلغاء_توكيل_سابق.Checked && removeAuthother != "")
                            {
                                colText = colText.Replace(removeAuthother, "") + " ";
                            }
                        }
                        catch (Exception ex) { }
                    }
        ...
        private void filteringRights( int caseIndex)
        {
            ...
            if (dtbl.Rows.Count > 0)
                ...
                foreach (DataRow dr in dtbl.Rows)
                {
                    textRights = dr["قائمة_الحقوق"].ToString();
                    //MessageBox.Show("قائمة_الحقوق " + textRights);
                }
    ...
    void FillContextView(string text)
        ...
        private string createAuthPart1(bool Auth)
        {
            ...
            else if (addAuthticIndex > 1)
            {
                try
                {
                    ...
                    string authDocType = نوع_هوية.Text.Split('_')[0] + " رقم ";
                    ...
                    for (int x = 1; x < addAuthticIndex; x++)
                    {
                        ...
                        authDocType = نوع_هوية.Text.Split('_')[x] + " رقم ";

                        if (هوية_الموكل.Text.Split('_')[x].Length > 2)
        ...
        public void panelShow(int panelIndex)
        {
            switch (panelIndex)
            {
                ...
                case 1:
                    ...
                    panelapplicationInfo.Location = new System.Drawing.Point(214, 38);
            ...
            التاريخ_الهجري.Text = HijriDate;
                   ...
                   // MessageBox.Show(هوية_الموكل.Text);
                    ...
                    if (قائمة_الحقوق.Text == "، وأذنت لمن يشهد والله خير الشاهدين")
                    {
                        قائمة_الحقوق.Text = SuffReplacements(txtRightListStar[0], صفة_مقدم_الطلب_off.SelectedIndex, صفة_الموكل_off.SelectedIndex);
        ...
        private void btnPanelapp_Click(object sender, EventArgs e)
        {
            ...
            {
                btnPanelapp.Height = Panelapp.Height = btnSaveApp.Height = 130;
                btnPanelapp.Text = "عرض";
            }
            else
            {
                btnPanelapp.Height = Panelapp.Height = btnSaveApp.Height = 130 * addNameIndex;
        ...
        private void btnPanelAuthPers_Click(object sender, EventArgs e)
        {
            ...
            {
                btnPanelAuthPers.Height = PanelAuthPers.Height = btnSaveAuth.Height = 90;
                btnPanelAuthPers.Text = "عرض";
            }
            else
            {
                btnPanelAuthPers.Height = PanelAuthPers.Height = btnSaveAuth.Height = 90 * addAuthticIndex;
                btnPanelAuthPers.Text = "تصغير";
            }
        }
        ...
        private void FormAuth_Load(object sender, EventArgs e)
        {
            ...
            fileComboBoxRights(الحقوق_off, DataSource, "ColRight", "TableAddContext", true);
        ...
        private void fileComboBoxRights(ComboBox combbox, string source, string comlumnName, string tableName, bool order)
        {
            //MessageBox.Show("source += "+source);
            combbox.Visible = true;
            //MessageBox.Show(source);
            ...
            using (SqlConnection saConn = new SqlConnection(source))
            {
                ...
                string query = "select * from TableAddContext";
                ...
                foreach (DataRow dataRow in table.Rows)
                {
                    string right = dataRow["altSubColName"].ToString().Replace(" ", "_") + "_" + dataRow["altColName"].ToString().Replace(" ", "_");
                    if (!String.IsNullOrEmpty(dataRow["altSubColName"].ToString()) && !String.IsNullOrEmpty(dataRow["altColName"].ToString()))
                        combbox.Items.Add(right.Replace("-", "_"));
                }
                saConn.Close();
            }
            //if (combbox.Items.Count > 0) combbox.SelectedIndex = 0;
        ...
        {
            var settings = new Settings(EmpName, GreDate, "57", false, "", DataSource, false, FilespathIn, FilespathOut, FilespathOut, FilespathIn, إجراء_التوكيل.SelectedIndex.ToString() + "-" + نوع_التوكيل.SelectedIndex.ToString());
            settings.Show();
        }
        ...
        {
            //MessageBox.Show(" checkBoxesJob1 + " + Environment.NewLine + قائمة_الحقوق.Text);
            if (إجراء_التوكيل.Text == "إختر الإجراء")
                return;
            resetBoxes(true);
            ...
            if (قائمة_الحقوق.Text == "")
            {
                //MessageBox.Show(" checkBoxesJob2 + " + Environment.NewLine + قائمة_الحقوق.Text);
                savedRights.Checked = false;
                صفة_الموكل_off.Enabled = true;
                bool genForm = false;
                if (نوع_التوكيل.Text == "توكيل بصيغة غير مدرجة") genForm = true;

                flllPanelItemsboxes("ColName", إجراء_التوكيل.Text + "-" + نوع_التوكيل.Text.ToString());
                //MessageBox.Show(" checkBoxesJob3 + " + Environment.NewLine + قائمة_الحقوق.Text);
                if (starText != "")
                {
                    starTectRightJob();
                    //MessageBox.Show(" checkBoxesJob4 + " + Environment.NewLine + قائمة_الحقوق.Text);
                }
                else
                {
                    ...
                    if (قائمة_الحقوق.Text == "")
                    {
                        //MessageBox.Show("checkBoxesJob7 " + قائمة_الحقوق.Text);
                        PopulateCheckBoxes(ColRight.Replace(" ", "_"), "TableAuthRights", DataSource, صفة_مقدم_الطلب_off.SelectedIndex, true);
                        //MessageBox.Show("checkBoxesJob3 + " + ColRight.Replace(" ", "_") + Environment.NewLine + قائمة_الحقوق.Text);
                        updateRight(قائمة_الحقوق.Text);
                        //MessageBox.Show("checkBoxesJob8 " + قائمة_الحقوق.Text);
                    }
            ...
            else
            {
                ...
                //MessageBox.Show(" checkBoxesJob9 + " + Environment.NewLine + قائمة_الحقوق.Text);
        ...
        private bool checkPayment()
        {
            if (checkReciptState() == "OK")
            {
                ...
                {
                    //MessageBox.Show(حالة_السداد.Text);
            ...
            private void authJob()
        {
            ...
            calcAuthSub(DataSource, col, txtReview.Text   , "TableAuthsub"           );
            calcAuthSub(DataSource, col, قائمة_الحقوق.Text, "TableAuthRightStarText");


        }
        private void calcAuthSub(string dataSource, string column, string text, string genTable)
        {
            string txtReviewOrg = "";
            
            if (!checkColExist(genTable, column))
            {
                CreateColumn(column, genTable, "max");
            }
            try
            {
                txtReviewOrg = SuffOrigConvertments(text);
            }

            catch (Exception ex1) { return; }
            
            Console.WriteLine(genTable + " - " + txtReviewOrg);
        ...
        private void addNewAppNameInfo()
        {
            ...
            for (int x = 0; x < addNameIndex; x++)
            {
                string query = "insert into TableGenNames ([الاسم], رقم_الهوية,تاريخ_الميلاد,المهنة,النوع,نوع_الهوية,مكان_الإصدار,انتهاء_الصلاحية) values (N'" + مقدم_الطلب.Text.Split('_')[x] + "',N'" + رقم_الهوية.Text.Split('_')[x] + "',N'" + تاريخ_الميلاد.Text.Split('_')[x] + "',N'" + المهنة.Text.Split('_')[x] + "',N'" + النوع.Text.Split('_')[x] + "',N'" + نوع_الهوية.Text.Split('_')[x] + "',N'" + مكان_الإصدار.Text.Split('_')[x] + "',N'" + انتهاء_الصلاحية.Text.Split('_')[x] + "') ;SELECT @@IDENTITY as lastid";
                string id = checkExist(مقدم_الطلب.Text.Split('_')[x]);
                if (id != "0")
                {
                    query = "update TableGenNames set [الاسم] =  N'" + مقدم_الطلب.Text.Split('_')[x]+"',[رقم_الهوية] = N'"+ رقم_الهوية.Text.Split('_')[x] + "',[تاريخ_الميلاد] = N'"+ تاريخ_الميلاد.Text.Split('_')[x]+"',[المهنة] = N'"+ المهنة.Text.Split('_')[x]+"',النوع = N'"+ النوع.Text.Split('_')[x]+"',نوع_الهوية = N'"+ نوع_الهوية.Text.Split('_')[x]+"',مكان_الإصدار = N'"+ مكان_الإصدار.Text.Split('_')[x]+"' ,انتهاء_الصلاحية = N'"+ انتهاء_الصلاحية.Text.Split('_')[x]+"' where ID = " + id;
                
                    
                }
                Console.WriteLine(query);
                //MessageBox.Show(انتهاء_الصلاحية.Text.Split('_')[x]);
                SqlConnection sqlConnection = new SqlConnection(DataSource);
                if (sqlConnection.State == ConnectionState.Closed)
                    sqlConnection.Open();
        ...
        private void footers()
        {
            ...
            else if (نوع_التوكيل.Text.Contains("توكيل محلي"))
                مدة_الاعتماد.Text = "";
        ...
        private void الحقوق_off_TextChanged(object sender, EventArgs e)
        {
            ...
            PopulateCheckBoxes(الحقوق_off.Text.Replace(" ", "_").Replace("-", "_"), "TableAuthRights", DataSource, صفة_مقدم_الطلب_off.SelectedIndex, false);
            قائمة_الحقوق.Text = removeSpaceRight(قائمة_الحقوق.Text);
            //MessageBox.Show("الحقوق_off " + قائمة_الحقوق.Text);
        }
        ...
        private void reversTextReview()
        {
            ...
            try
            {
                ...
                foreach (DataRow dataRow in dtbl.Rows)
                {
                    if (dataRow[col].ToString() != "" && !dataRow[col].ToString().Contains("removed"))
                    {
                    ...
                    if (dataRow[col].ToString() != "" && dataRow[col].ToString().Contains("Star") && !dataRow[col].ToString().Contains("removed")) continue;
                    {
                        ...
                        Console.WriteLine("Star " + txtReviewList[txtReviewListIndex]);
        ...
        {
            string col = نوع_التوكيل .Text.Replace(" ", "_") + "_" + إجراء_التوكيل.Text.Replace(" ", "_");
            string query = "select " + col + " from TableAuthRightStarText where " + col + " is not null order by ID desc";
            ...
            try
            {
                ...
                sqlCon.Close();
                txtRightListIndex = 1;
                txtRightListIndexStar = 1;
                txtRightList = new string[dtbl.Rows.Count + 1];
                txtRightListStar = new string[dtbl.Rows.Count + 1];
                foreach (DataRow dataRow in dtbl.Rows)
                {
                    if (dataRow[col].ToString() != "" && !dataRow[col].ToString().Contains("removed"))
                    {
                        txtRightList[txtRightListIndex] = dataRow[col].ToString();
                        Console.WriteLine(txtRightList[txtRightListIndex]);
                        txtRightListIndex++;
                    }
                    if (dataRow[col].ToString() != "" && !dataRow[col].ToString().Contains("removed") && dataRow[col].ToString().Contains("Star"))
                    {
                        txtRightListStar[txtRightListIndexStar] = dataRow[col].ToString().Replace("Star", "");
                        //Console.WriteLine(txtRightListStar[txtRightListIndexStar]);
                        //MessageBox.Show(txtRightListStar[txtRightListIndexStar]);
                        txtRightListIndexStar++;
                    }
                }
            }
            catch (Exception ex)
            {
                txtRightList = new string[1];
                txtRightListStar = new string[1];
            }
            //MessageBox.Show(col);
            txtRightListStar[0] = getRights(col.Replace(" ", "_"), "TableAuthRights", DataSource);
            if (txtRightListStar[0] == "")
                txtRightListStar[0] = getRights("الصيغة_العامة", "TableAuthRights", DataSource);
            //MessageBox.Show(txtRightListStar[0]);
        }
        ...
        private string SuffReversReplacements(string text, int appCaseIndex, int intAuthcases, string type)
        {
            ...
            //MessageBox.Show(text);
            text = SuffConvertments(text, صفة_مقدم_الطلب_off.SelectedIndex, صفة_الموكل_off.SelectedIndex, type);
            //MessageBox.Show(text);
            return text;
        }
        ...
        private void pictureBox3_Click(object sender, EventArgs e)
        {
            ...
            authOthers();
            removedPreAuth();
            label11.Text = "الاختيار من قائمة المفضلة (" + txtRigIndex.ToString() + "/" + txtRightListIndex.ToString() + ")"; 
            txtRigIndex++;
            قائمة_الحقوق.Text = removeSpaceRight(قائمة_الحقوق.Text);
        ...
        private string removeSpaceSub(string text)
        {
            string authother = "";
            string removeAuthother = "";
            string lastSentence = "";
            ...
            try
            {
                text = text.Replace(lastSentence, "");
            }
            catch (Exception ex) { }
        ...
        private string removeSpaceRight(string text)
        {
            string authother = "";
            string removeAuthother = "";
            string lastSentence = "";
        ...
        private void updateText(TextBox text)
        {
            ...
            string textRevers = SuffReversReplacements(text.Text, 0, 0, "موضوع التوكيل") + "Star";
            ...
            if (!checkStarTextExist(DataSource, نوع_التوكيل.Text.Replace(" ", "_") + "_" + إجراء_التوكيل.Text.Replace(" ", "_"), SuffReversReplacements(text.Text, 0, 0, "موضوع التوكيل"), "TableAuthsub"))
        ...
        private void picStarSub_Click(object sender, EventArgs e)
        {
            ...
            if (txtRevStarIndex == txtReviewStarIndex) 
                txtRevStarIndex = 0;
            if (txtReviewListStar[txtRevStarIndex] != "")
            {
        ...
        private void picStarRight_Click(object sender, EventArgs e)
        {
            ...
            if (txtReviewLast == "")
                txtReviewLast = txtReview.Text;
            if (starRightIndexStar >= txtRightListIndexStar)
                starRightIndexStar = 0;
            if (txtRightListStar[starRightIndexStar] != "")
            {
                string text = txtRightListStar[starRightIndexStar];
                قائمة_الحقوق.Text = SuffReplacements(text, صفة_مقدم_الطلب_off.SelectedIndex, صفة_الموكل_off.SelectedIndex);
                قائمة_الحقوق.Text = removeSpaceRight(قائمة_الحقوق.Text);
                
            }
            label11.Text = "الاختيار من قائمة المفضلة (" + starRightIndexStar.ToString() + "/" + txtRightListIndexStar.ToString() + ")"; 
            starRightIndexStar++;            
        }
        ...
        private void هوية_الموكل_TextChanged(object sender, EventArgs e)
        {
            //MessageBox.Show("تغيير " + هوية_الموكل.Text);
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            PaymentRequest("توضيح_التجاوز", "TableAuth", comboReasons.Text + "-" + txtExplanation.Text,"");
